...
Arquivo & Tamanho & Blocos & Tempo (s) & Throughput & SHA-256 \\
\midrule
File A & 10\,KB  &    3 & 0,50 &  19,9\,KB/s & OK \\
File A & 20\,KB  &    5 & 0,50 &  39,8\,KB/s & OK \\
File B &  1\,MB  &  256 & 0,57 &\textbf{1\,790,6\,KB/s} & OK \\
File B &  5\,MB  & 1280 & 0,87 &\textbf{5\,908,8\,KB/s} & OK \\
File C & 10\,MB  & 2560 & 1,54 &\textbf{6\,661,7\,KB/s} & OK \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
File A & 10\,KB & B, C, D &   0,50 &  19,9\,KB/s & OK \\
File B &  1\,MB & B, C, D &  $\leq$0,65 & $\geq$1\,576\,KB/s & OK \\
File C & 10\,MB & B & 2,23 & 4\,600,3\,KB/s & OK \\
File C & 10\,MB & C & 2,03 & 5\,057,8\,KB/s & OK \\
File C & 10\,MB & D & 1,98 & 5\,165,7\,KB/s & OK \\
\bottomrule
\end{tabular}
\end{table}
...
arquivos médios e grandes. Com conexões persistentes, o ganho é ainda mais
evidente: $\approx 1{,}79$\,MB/s com 4\,KB contra $\approx 935$\,KB/s com 1\,KB
no File B de 1\,MB, e $\approx 6{,}66$\,MB/s contra $\approx 694$\,KB/s no
File C de 10\,MB. Para arquivos pequenos (10--20\,KB) o impacto é desprezível,
pois o overhead de handshake domina o tempo total.

\paragraph{Impacto do número de peers.}
Com 4 peers, C e D podem buscar blocos no peer B (que já os recebeu de A)
em paralelo à transferência A$\to$B, distribuindo a carga do seeder inicial.
No teste com File C (10\,MB) e 4 peers, os três leechers concluíram com
throughput entre 4,6 e 5,2\,MB/s, confirmando que a carga foi distribuída
entre os peers B e A. O servidor não-bloqueante baseado em \texttt{select()}
permitiu que o seeder atendesse múltiplos leechers simultâneos com um único
loop de eventos, sem degradação perceptível de throughput.
